    ...
    def update(
        ...
        for tracker_id, bbox in detections:
            ...
            if tracker_id in self.tracker_to_global:
                ...
                # New tracker ID - queue for matching
                unmatched_detections.append((tracker_id, bbox, embedding, histogram))
        
        # ========================================
        # PHASE 2: Try to match with lost players
        # ========================================
        ...
        # ========================================
        # PHASE 3: Handle disappeared players
        # ========================================
        ...
        # ========================================
        # PHASE 4: Cleanup old lost players
        # ========================================
        to_remove = [
        ...
        for gid in to_remove:
            ...
            print(f"🗑️ Frame {self.current_frame}: Removed player {gid} from memory")
...
class SoccerPlayerTracker:
    """
    Main tracker combining YOLO detection/tracking with enhanced ReID.
    """
    ...
    def run(self, show_team_colors: bool = True, player_classes: List[int] = [1, 2]):
        ...
        Args:
            show_team_colors: If True, use team colors instead of unique colors
            player_classes: YOLO class IDs for players
        """
        print("\n" + "="*60)
